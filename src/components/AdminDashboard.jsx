  ...
  return (
    <main className="admin-page">
      <section className="admin-header">
        ...
        <div className="admin-header-actions"><Notifications items={adminNotifications} storageKey="leanfitAdminNotificationReads" title="Admin notifications" /><button className="secondary-btn" onClick={() => setPage("email-templates")}>Email Templates</button><button className="secondary-btn" onClick={() => setPage("welcome")}>Back to Website</button></div>
      </section>
